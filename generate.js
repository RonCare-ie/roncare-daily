...
const NAV_HTML = `
  <div style="background:#3d1a0e;height:6px;width:100%;"></div>
  <nav style="background:#f5efe6;border-bottom:1px solid #e8ddd0;padding:0 32px;display:flex;align-items:center;justify-content:space-between;height:64px;font-family:Georgia,serif;">
    <a href="https://www.roncare.ie/" style="display:flex;align-items:center;gap:10px;text-decoration:none;">
      <img src="https://www.roncare.ie/icon.png" alt="RonCare" style="height:36px;width:36px;">
      <span style="font-size:20px;font-weight:bold;color:#3d1a0e;letter-spacing:0.01em;">RonCare</span>
    </a>
    <div style="display:flex;gap:32px;align-items:center;">
      <a href="https://www.roncare.ie/blog/" style="font-size:13px;font-weight:600;letter-spacing:0.08em;color:#3d1a0e;text-decoration:none;">BLOG</a>
      <a href="https://www.roncare.ie/#waitlist" style="font-size:13px;font-weight:600;letter-spacing:0.08em;color:#3d1a0e;text-decoration:none;">WAITLIST</a>
      <a href="https://www.roncare.ie/founder" style="font-size:13px;font-weight:600;letter-spacing:0.08em;color:#3d1a0e;text-decoration:none;">FOUNDER INTRO</a>
      <a href="https://www.roncare.ie/resources" style="font-size:13px;font-weight:600;letter-spacing:0.08em;color:#3d1a0e;text-decoration:none;">RESOURCES</a>
    </div>
    <a href="https://www.roncare.ie/#waitlist" style="background:#b94a1e;color:#fff;padding:10px 22px;border-radius:24px;font-size:14px;font-weight:600;text-decoration:none;white-space:nowrap;">Join the Waitlist</a>
  </nav>`;
