...
function navHTML(iconSrc) {
  return `
  <nav style="background:#F5EDE3;border-bottom:1px solid #e0d4c4;padding:0 32px;display:flex;align-items:center;justify-content:space-between;height:64px;font-family:Georgia,serif;position:sticky;top:0;z-index:50;">
    <a href="https://www.roncare.ie/" style="display:flex;align-items:center;gap:10px;text-decoration:none;">
      <img src="${iconSrc}" alt="RonCare" style="height:48px;width:48px;">
      <span style="font-size:18px;font-weight:700;color:#C15A2E;letter-spacing:0.03em;">RonCare</span>
    </a>
    <div style="display:flex;gap:32px;align-items:center;">
      <a href="https://www.roncare.ie/blog/" style="font-size:12px;font-weight:600;letter-spacing:0.1em;color:#C15A2E;text-decoration:none;">BLOG</a>
      <a href="https://www.roncare.ie/#waitlist" style="font-size:12px;font-weight:600;letter-spacing:0.1em;color:#C15A2E;text-decoration:none;">WAITLIST</a>
      <a href="https://www.roncare.ie/founder" style="font-size:12px;font-weight:600;letter-spacing:0.1em;color:#C15A2E;text-decoration:none;">FOUNDER INTRO</a>
      <a href="https://www.roncare.ie/resources" style="font-size:12px;font-weight:600;letter-spacing:0.1em;color:#C15A2E;text-decoration:none;">RESOURCES</a>
    </div>
    <a href="https://www.roncare.ie/#waitlist" style="background:#C15A2E;color:#F5EDE3;padding:9px 20px;border-radius:24px;font-size:13px;font-weight:600;text-decoration:none;white-space:nowrap;">Join the Waitlist</a>
  </nav>`;
}
